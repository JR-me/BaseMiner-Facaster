...
contract BaseMiner {
    ...
    ///      worst-case from O(MAX_LB) to O(MAX_LB²) per mine() call. Profile before
    ///      raising this value.
    uint256   public constant MAX_LB = 10;

    uint256 public constant MAX_BBALL_GLOBAL  = 1_009_400;
    uint256 public constant MAX_BBALL_PER_USER =    9_800;
