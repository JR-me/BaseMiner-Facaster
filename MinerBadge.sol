...
contract MinerBadge {
    ...
    string public constant symbol = "BBADGE";
    ...
    /// @notice Claim your Legendary badge. Requires 9,800 bBall + top-10 leaderboard.
    ...
    function _claimTier(Tier tier) internal {
        ...
        if (tier == Tier.Common) {
            ...
            // Legendary
            require(totalMined >= RARE_THRESHOLD,              "Mine at least 9,800 bBall to claim Legendary");
